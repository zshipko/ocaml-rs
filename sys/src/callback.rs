...
extern "C" {
    ...
    pub fn caml_main(argv: *mut *mut std::os::raw::c_char);
    pub fn caml_startup(argv: *mut *mut std::os::raw::c_char);
    pub fn caml_shutdown();
    pub fn caml_named_value(name: *const std::os::raw::c_char) -> *const Value;
