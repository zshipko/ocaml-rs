...
extern "C" {
    ...
    pub fn caml_copy_string(string: *const std::os::raw::c_char) -> Value;
    pub fn caml_copy_string_array(arr: *const *const std::os::raw::c_char) -> Value;
    ...
    pub fn caml_alloc_array(
        value: unsafe extern "C" fn(*const std::os::raw::c_char) -> Value,
