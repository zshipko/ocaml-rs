...
pub fn release_runtime_system() {
    unsafe { core::memory::caml_enter_blocking_section() }
}

/// Obtain global lock
pub fn acquire_runtime_system() {
    unsafe { core::memory::caml_leave_blocking_section() }
}
...
pub fn raise_out_of_memory() {
    unsafe { core::fail::caml_raise_out_of_memory() }
}
...
pub fn raise_end_of_file() {
    unsafe { core::fail::caml_raise_end_of_file() }
}

pub fn raise_zero_divide() {
    unsafe { core::fail::caml_raise_zero_divide() }
}

pub fn raise_not_found() {
    unsafe { core::fail::caml_raise_not_found() }
}

pub fn array_bound_error() {
    unsafe { core::fail::caml_array_bound_error() }
}

pub fn raise_sys_blocked_io() {
    unsafe { core::fail::caml_raise_sys_blocked_io() }
}
